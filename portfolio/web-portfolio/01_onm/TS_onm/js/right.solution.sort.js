...
$(function () {
	...
	// 	$('.welcome').slick('slickPlay');
	// 	console.log("go");
	// });
	// $('.welcome .pause').on('click', function(){
	// 	$('.welcome').slick('slickPause');
	// });
...
$(function () {
	$('.faq_drop_title').click(function () {
		$(this).siblings('.faq_drop_content').slideUp();
		$(this).next().slideDown();
		$(this).addClass('active');
		$(this).siblings('.faq_drop_title').removeClass('active');
	});
});
/* notice drop accordion */
$(function () {
	$('.notice_drop_title').click(function () {
		$(this).siblings('.notice_drop_content').slideUp();
		$(this).next().slideDown();
		$(this).addClass('active');
		$(this).siblings('.notice_drop_title').removeClass('active');
	});
});